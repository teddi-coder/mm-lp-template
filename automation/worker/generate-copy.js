...
function parseCopyResponse(text) {
  ...
  return {
    ...
    checklistHeadline: extract('7b\\. SERVICE CHECKLIST HEADLINE'),
    checklistItems: extractList('7c\\. SERVICE CHECKLIST ITEMS'),
    benefitsHeadline: extract('7d\\. BENEFIT CARDS HEADLINE'),
    benefitCards: extractPairs('7e\\. BENEFIT CARDS \\(4 items\\)'),
    howItWorksHeadline: extract('7f\\. HOW IT WORKS HEADLINE'),
    howItWorksSteps: extract('7g\\. HOW IT WORKS STEPS \\(exactly 3\\)'),
    ...
    reviewsHeadline: extract('14. REVIEWS SECTION HEADLINE'),
    footerCta: {
    ...
    CHECKLIST: extract('18. CHECKLIST'),
    HOW_IT_WORKS: extract('19. HOW_IT_WORKS'),
    REVIEWS: extract('20. REVIEWS'),
    ABOUT_PARAGRAPH: extract('21. ABOUT_PARAGRAPH'),
  };
}
